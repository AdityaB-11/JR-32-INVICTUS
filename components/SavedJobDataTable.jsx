...
export default function SavedJobDataTable() {
    ...
    const columns = [
        ...
        {
            name: '',
            cell: row => <button onClick={() => router.push(`/frontend/jobDetails/${row?.job?._id}`)} className='md:px-2 md:py-2 px-1 py-1 text-xs texteal hover:text-white my-2 hover:bteal border bordeteal   rounded transition-all duration-700  '>view Detail</button>,
        },
    ];
